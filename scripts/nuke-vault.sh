...
# credentials (Harbor robot, Cloudflare token, etc.) will need to be
# re-supplied before the next seed.
#
...
main() {
  ...
  echo "Next: pre-load externally minted creds (Harbor, Cloudflare) and re-run scripts/seed-vault.sh."
}
